...
const infoSection = {
  calculatorDescription: (
    <div className="space-y-4">
      <p>
        <strong>토크(Torque) 계산기</strong>는 물체를 특정 축을 중심으로 회전시키려는 힘의 경향을 정확하게 측정하는 물리학 도구입니다. 토크는 단순히 물체를 밀거나 당기는 직선적인 힘과는 달리, 힘이 가해지는 위치와 방향에 따라 그 효과가 달라지는 회전 운동의 핵심 물리량입니다.
      </p>
      <p>
      ...
      <p>
        토크는 자동차 엔진의 회전력, 자전거 페달의 작용력, 나사와 볼트를 조이는 공구의 힘, 심지어 전기 모터의 출력에 이르기까지 기계 시스템의 설계와 분석에 핵심적인 역할을 합니다.
      </p>
      <p className="p-4 bg-blue-50 dark:bg-blue-900/30 border-l-4 border-blue-500 rounded-r-lg">
        이 계산기는 힘과 회전축으로부터의 거리를 입력받아, 힘이 거리에 수직으로 작용할 때 발생하는 토크의 크기를 계산합니다. 학생들에게는 회전 역학을 이해시키는 교육 도구로서, 엔지니어들에게는 기계 설계, 구조 분석, 동력 시스템 개발 등에서 정확한 토크 데이터를 제공하는 실용적인 도구로 활용됩니다.
      </p>
    </div>
  ),
  calculationFormula: (
    <div className="space-y-6">
      <div>
        ...
        <ul className="mt-4 space-y-2 text-sm">
          <li><strong className="font-semibold">τ (tau)</strong>: 토크, 국제 표준 단위는 뉴턴미터(N·m)</li>
          <li><strong className="font-semibold">r (radius)</strong>: 회전축에서 힘이 작용하는 지점까지의 거리(레버 암), 단위는 미터(m)</li>
          <li><strong className="font-semibold">F (Force)</strong>: 가해지는 힘, 단위는 뉴턴(N)</li>
          <li><strong className="font-semibold">θ (theta)</strong>: 거리 벡터와 힘 벡터 사이의 각도</li>
        </ul>
      </div>
      <div>
        <h4 className="font-bold text-lg mb-2 border-l-4 border-yellow-500 pl-3">단순화된 공식 (수직 작용 시)</h4>
        <p>힘이 레버 암에 대해 수직(θ = 90°)으로 작용하면 sin(90°) = 1이므로:</p>
        <div className="p-4 bg-muted rounded-lg">
  ...
  usefulTips: (
    <div className="space-y-6">
      <div>
        <h4 className="font-bold text-lg mb-2 border-l-4 border-yellow-500 pl-3">토크를 최대화하는 방법</h4>
        <p>토크를 최대로 만들기 위한 세 가지 핵심 요소가 있습니다.</p>
        <ul className="mt-2 list-decimal list-inside space-y-2">
          <li><strong>더 큰 힘 가하기:</strong> 더 세게 밀거나 당기면 토크가 커집니다.</li>
          <li><strong>레버 암 길게 하기:</strong> 회전축에서 최대한 멀리 떨어진 곳에 힘을 가합니다.</li>
          <li><strong>각도를 90도로:</strong> 레버 암에 수직으로 힘을 가할 때 토크가 최대가 됩니다.</li>
        </ul>
      </div>
      <div>
        ...
        <ul className="space-y-3">
          <li className="p-3 border rounded-lg">
            ...
            <p className="text-xs mt-1">
              렌치, 스패너, 드라이버 등 모든 공구는 토크의 원리를 활용합니다. 토크 렌치는 특정 토크 값으로 정확하게 조이기 위해 사용됩니다.
            </p>
          </li>
          <li className="p-3 border rounded-lg">
            <p className="font-semibold text-sm">자동차</p>
            <p className="text-xs mt-1">
              '최대 토크'는 엔진이 낼 수 있는 최대 회전력을 의미하며, 정지 출발이나 언덕 오를 때 성능을 결정합니다.
            </p>
          </li>
          <li className="p-3 border rounded-lg">
            <p className="font-semibold text-sm">자전거</p>
            <p className="text-xs mt-1">
              페달을 밟아 크랭크를 돌리는 것이 토크를 생성하는 과정이며, 기어 변속은 토크 관계를 조절하는 것입니다.
            </p>
          </li>
        </ul>
      </div>
      <div className="p-4 bg-blue-50 dark:bg-blue-900/30 border-l-4 border-blue-500 text-blue-800 dark:text-blue-200 rounded-r-lg">
        <p className="font-bold text-sm">오른손 법칙</p>
        <p className="text-xs mt-1">
          토크는 벡터량으로, 방향은 오른손 법칙으로 결정합니다. 오른손 네 손가락을 회전 방향으로 감았을 때, 엄지손가락이 가리키는 방향이 토크 벡터의 방향입니다.
        </p>
      </div>
      <div>
        <h4 className="font-bold text-lg mb-2 border-l-4 border-teal-500 pl-3">단위 변환</h4>
        <ul className="list-disc list-inside space-y-2 mt-2">
          <li><strong>1 N·m</strong> = 1 줄(J)</li>
