  ...
  const infoSection = {
    calculatorDescription: (
      <>
        ...
        <p className="mt-4">
          특히 대출 상환 방식은 매월 납부해야 하는 금액과 총 이자 비용에 직접적인 영향을 미치기 때문에 가장 중요하게 고려해야 할 요소 중 하나입니다. 상환 방식은 크게 <strong>원리금 균등분할상환, 원금 균등분할상환, 만기일시상환</strong> 세 가지로 나뉩니다. 각 방식의 장단점이 뚜렷하여 어떤 방식을 선택하느냐에 따라 자금 운용 계획이 크게 달라질 수 있습니다.
        </p>
        <p className="mt-4">
          <strong>All_in_Calc의 대출 이자 계산기</strong>는 바로 이러한 복잡함을 해결해 드립니다. 대출 원금, 기간, 금리만 입력하면 세 가지 상환 방식에 따른 월별 상환금, 총 이자, 상환 스케줄을 한눈에 비교하여 보여줍니다.
        </p>
        <ul className="list-disc pl-5 mt-2 space-y-1">
          <li>나의 소득 수준과 자금 계획에 가장 적합한 상환 방식은 무엇일까?</li>
          <li>상환 방식에 따라 총 이자 부담은 얼마나 차이 날까?</li>
          <li>매월 내가 갚아나가는 원금과 이자는 얼마일까?</li>
        </ul>
        <p className="mt-4">
          이제 막연한 추측이 아닌, 정확한 데이터를 기반으로 가장 유리한 대출 전략을 세워보세요. 현명한 금융 결정의 첫걸음을 Alla_ina_Calc과 함께 시작하세요.
        </p>
      </>
    ),
    calculationFormula: (
      <>
        <h3 className="text-lg font-semibold mt-6 mb-3">🤔 어떤 상환 방식이 나에게 맞을까?</h3>
        <p>
          대출 상환 방식은 각각의 특징이 명확하므로, 자신의 현재 소득, 미래 소득 예상, 자금 운용 계획 등을 종합적으로 고려하여 선택해야 합니다.
        </p>
        <div className="space-y-6 mt-4">
          <div>
            <h4 className="font-semibold text-md mb-2">1. 원리금 균등분할상환 (가장 일반적인 방식)</h4>
            <p className="text-sm">매월 상환하는 원금과 이자의 합계(원리금)가 대출 기간 내내 동일하게 유지되는 방식입니다. 초기에는 이자 비중이 높고 원금 비중이 낮지만, 시간이 지날수록 이자 비중이 줄고 원금 비중이 늘어나는 구조입니다.</p>
            <p className="font-mono p-2 bg-muted rounded-md my-2 text-sm"><strong>월 상환금 = P × [r(1+r)^n] / [(1+r)^n - 1]</strong></p>
            <ul className="list-disc pl-5 text-sm space-y-1">
              <li><strong>장점:</strong> 매월 동일한 금액을 상환하므로, 예측 가능하고 안정적인 자금 계획을 세울 수 있습니다.</li>
              <li><strong>단점:</strong> 원금 균등방식에 비해 총 이자 부담이 다소 높습니다.</li>
              <li><strong>추천 대상:</strong> 매월 고정적인 소득이 있고, 계획적인 지출 관리를 선호하는 직장인에게 적합합니다.</li>
            </ul>
          </div>
          <div>
            <h4 className="font-semibold text-md mb-2">2. 원금 균등분할상환 (총 이자가 가장 적은 방식)</h4>
            <p className="text-sm">대출 원금을 대출 기간으로 균등하게 나누어 매월 동일한 원금을 상환하고, 이자는 남은 원금에 대해서만 계산하여 납부하는 방식입니다. 따라서 초기 상환 부담이 가장 크고, 시간이 지날수록 월 상환금이 점차 줄어듭니다.</p>
            <p className="font-mono p-2 bg-muted rounded-md my-2 text-sm"><strong>월 원금 상환액 = P / n</strong><br /><strong>초기 월 이자 = (P - (k-1) × (P/n)) × r</strong></p>
            <ul className="list-disc pl-5 text-sm space-y-1">
              <li><strong>장점:</strong> 세 가지 방식 중 총 이자 부담이 가장 적습니다.</li>
              <li><strong>단점:</strong> 초기 상환액이 커서 부담이 될 수 있습니다.</li>
              <li><strong>추천 대상:</strong> 초기 자금 여유가 있거나, 향후 소득 감소가 예상되는 은퇴 예정자에게 유리할 수 있습니다.</li>
            </ul>
          </div>
          <div>
            <h4 className="font-semibold text-md mb-2">3. 만기일시상환 (월 부담이 가장 적은 방식)</h4>
            <p className="text-sm">대출 기간 동안에는 매월 이자만 납부하고, 만기일에 원금 전액을 한 번에 상환하는 방식입니다. 주로 단기 대출이나 전세자금 대출 등에서 사용됩니다.</p>
            <p className="font-mono p-2 bg-muted rounded-md my-2 text-sm"><strong>월 이자 = P × r</strong></p>
            <ul className="list-disc pl-5 text-sm space-y-1">
              <li><strong>장점:</strong> 매월 이자만 내므로 월 상환 부담이 가장 적습니다. 대출금을 투자 등으로 활용하여 더 높은 수익을 기대할 수 있습니다.</li>
              <li><strong>단점:</strong> 총 이자 부담이 가장 큽니다. 만기 시 원금 상환 부담이 매우 큽니다.</li>
              <li><strong>추천 대상:</strong> 단기간 자금을 융통할 필요가 있거나, 만기 시 원금을 확실히 상환할 수 있는 계획이 있는 경우에 적합합니다.</li>
            </ul>
          </div>
        </div>
        <p className="text-xs mt-4 text-gray-500">※ P: 대출원금, r: 월이율, n: 총 상환 개월 수, k: 현재 상환 회차</p>
      </>
    ),
    usefulTips: (
      <>
        <h3 className="text-lg font-semibold mt-6 mb-3">💡 현명한 대출을 위한 5가지 꿀팁</h3>
        <ul className="lista_none space-y-6">
          <li>
            <h4 className="font-semibold text-md mb-1">1. DSR(총부채원리금상환비율)을 먼저 확인하세요.</h4>
            <p>
              DSR은 연 소득 대비 모든 가계대출의 연간 원리금 상환액 비율을 의미하며, 현재 금융권 대출 심사의 핵심 기준입니다. 자신의 DSR을 미리 계산해보고, 대출 가능한 한도를 파악하는 것이 중요합니다. 일반적으로 은행권은 DSR 40% 이내를 요구합니다.
            </p>
          </li>
          <li>
            <h4 className="font-semibold text-md mb-1">2. '중도상환수수료'를 반드시 고려하세요.</h4>
            <p>
          ...
          <li>
            <h4 className="font-semibold text-md mb-1">3. 금리 변동기에는 '고정금리'와 '변동금리'의 유불리를 따져보세요.</h4>
            <p>
          ...
          <li>
            <h4 className="font-semibold text-md mb-1">4. '금리인하요구권'을 적극적으로 활용하세요.</h4>
            <p>
          ...
          <li>
            <h4 className="font-semibold text-md mb-1">5. 여러 금융사의 상품을 한 번에 비교하세요.</h4>
            <p>
