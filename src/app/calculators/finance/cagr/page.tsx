    ...
    calculationFormula: (
      <>
        ...
        <div className="mt-6 space-y-4 text-sm">
          <p><strong className="text-primary">- 최종 가치 / 초기 가치:</strong> 전체 기간 동안 자산이 총 몇 배로 성장했는지를 나타냅니다.</p>
          <p><strong className="text-primary">- ^(1 / 기간):</strong> '거듭제곱근' 계산입니다. 총 성장 배수를 투자 기간(년)으로 나누어 연평균 성장률을 구하는 과정입니다. 예를 들어 5년이면 5제곱근을, 10년이면 10제곱근을 취하는 것과 같습니다.</p>
          <p><strong className="text-primary">- (- 1) * 100:</strong> 계산된 연평균 성장률을 백분율(%)로 변환합니다.</p>
        </div>
      ...
      <>
        ...
        <ul className="space-y-6">
          <li className="p-4 rounded-md bg-muted shadow">
            <h4 className="font-semibold text-lg mb-2 text-primary">1. '기간'이 다른 투자 성과, 공정하게 비교하기</h4>
          ...
          <li className="p-4 rounded-md bg-muted shadow">
            <h4 className="font-semibold text-lg mb-2 text-primary">2. '과정의 변동성'이라는 숨겨진 리스크를 인지하기</h4>
          ...
          <li className="p-4 rounded-md bg-muted shadow">
            <h4 className="font-semibold text-lg mb-2 text-primary">3. 과거 데이터는 참고자료일 뿐, 미래를 보장하지 않는다</h4>
          ...
          <li className="p-4 rounded-md bg-muted shadow">
            <h4 className="font-semibold text-lg mb-2 text-primary">4. '72의 법칙'으로 복리의 힘을 직관적으로 이해하기</h4>
          ...
          <li className="p-4 rounded-md bg-muted shadow">
            <h4 className="font-semibold text-lg mb-2 text-primary">5. CAGR의 한계를 명확히 알고 보완 지표 활용하기</h4>
