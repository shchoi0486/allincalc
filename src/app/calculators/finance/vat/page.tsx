  ...
  const infoSection = {
    ...
    calculationFormula: (
      <div className="space-y-4 p-4 bg-muted rounded-md">
        ...
        <div className="mt-4">
          ...
          <p className="pl-4 mt-1 bg-card p-2 rounded">- 부가세 = <code>공급가액 × 0.1</code></p>
          <p className="pl-4 mt-1 bg-card p-2 rounded">- 합계금액 = <code>공급가액 + 부가세</code></p>
        </div>
        <div className="mt-4">
          <h4 className="font-semibold">2. 합계금액으로 계산할 때</h4>
          <p className="pl-4 mt-1 bg-card p-2 rounded">- 공급가액 = <code>합계금액 ÷ 1.1</code> (소수점 이하는 일반적으로 버림 또는 반올림 처리)</p>
          <p className="pl-4 mt-1 bg-card p-2 rounded">- 부가세 = <code>합계금액 - 공급가액</code></p>
          <p className="text-sm text-muted-foreground mt-1">합계 금액에 이미 10%의 부가세가 포함되어 있으므로, 1.1로 나누어 부가세가 포함되기 전의 원래 가격(공급가액)을 구하는 원리입니다.</p>
          <div className="mt-4 p-4 bg-card rounded-md border border-border">
            <h4 className="font-semibold text-foreground mb-2">계산 예시</h4>
            <p className="text-sm text-muted-foreground">공급가액 100,000원인 경우</p>
            <p className="font-mono text-sm text-primary mt-1">부가세 = 100,000 × 0.1 = 10,000원</p>
            <p className="font-mono text-sm text-primary">합계금액 = 100,000 + 10,000 = 110,000원</p>
            <p className="text-sm text-muted-foreground mt-2">합계금액 110,000원만 아는 경우</p>
            <p className="font-mono text-sm text-primary">공급가액 = 110,000 ÷ 1.1 = 100,000원, 부가세 = 10,000원</p>
          </div>
        </div>
      </div>
    ),
    usefulTips: (
      <div className="space-y-6">
        <div>
          <h4 className="font-semibold text-lg border-l-4 border-primary pl-3 mb-2">1. 부가세 신고 및 납부, 언제까지 해야 할까? (2025년 기준)</h4>
        ...
        <div>
          <h4 className="font-semibold text-lg border-l-4 border-primary pl-3 mb-2">2. 가장 중요한 증빙, '세금계산서'와 '현금영수증'</h4>
        ...
        <div>
          <h4 className="font-semibold text-lg border-l-4 border-primary pl-3 mb-2">3. 나는 일반과세자? 간이과세자?</h4>
        ...
        <div>
          <h4 className="font-semibold text-lg border-l-4 border-primary pl-3 mb-2">4. 부가세가 없는 거래도 있다? (면세와 영세율)</h4>
        ...
        <div>
          <h4 className="font-semibold text-lg border-l-4 border-primary pl-3 mb-2">5. 홈택스를 이용한 셀프 신고 활용하기</h4>
