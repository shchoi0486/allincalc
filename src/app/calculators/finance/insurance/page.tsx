...
const InsuranceCalculator: NextPage = () => {
  ...
  const infoSection = {
    ...
    calculationFormula: (
      <div className="text-base leading-relaxed space-y-8">
        ...
        <div className="p-5 rounded-lg bg-gray-100 dark:bg-gray-800 border-l-4 border-blue-500">
          <h3 className="text-xl font-bold text-blue-600 dark:text-blue-400 mb-3">1. 국민연금 (총 9%) - 당신의 노후를 위한 최소한의 약속</h3>
          <p className="mb-3">국민연금은 노령, 장애, 사망과 같은 예기치 못한 상황이 발생했을 때, 본인이나 유족에게 연금을 지급하여 안정적인 삶을 지원하는 사회보장제도입니다.</p>
          <p className="font-mono p-4 bg-white dark:bg-gray-900 rounded-md text-sm">보험료 = 기준소득월액 × 9%</p>
          <div className="grid grid-cols-2 gap-2 mt-3 text-sm">
            <div><strong>근로자 부담:</strong> 4.5%</div>
            <div><strong>사업주 부담:</strong> 4.5%</div>
          </div>
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">※ 2025년 기준소득월액: <strong>하한 390,000원 ~ 상한 6,170,000원</strong> 범위 내에서 적용됩니다. (변동 가능)</p>
        </div>

        <div className="p-5 rounded-lg bg-gray-100 dark:bg-gray-800 border-l-4 border-green-500">
          <h3 className="text-xl font-bold text-green-600 dark:text-green-400 mb-3">2. 건강보험 (총 7.09%) - 아플 때 기댈 수 있는 든든한 어깨</h3>
          <p className="mb-3">질병이나 부상으로 인한 의료비 부담을 줄여주고, 정기적인 건강검진 서비스를 제공하여 국민의 건강을 지키는 핵심적인 사회보험입니다.</p>
          <p className="font-mono p-4 bg-white dark:bg-gray-900 rounded-md text-sm">보험료 = 보수월액 × 7.09%</p>
          <div className="grid grid-cols-2 gap-2 mt-3 text-sm">
          ...
          <div className="mt-4 pt-4 border-t border-gray-300 dark:border-gray-700">
            ...
            <p className="font-mono p-3 bg-white dark:bg-gray-900 rounded-md text-xs mt-2">보험료 = 건강보험료 × 12.95% (근로자/사업주 절반씩 부담)</p>
          </div>
        </div>

        <div className="p-5 rounded-lg bg-gray-100 dark:bg-gray-800 border-l-4 border-yellow-500">
          <h3 className="text-xl font-bold text-yellow-600 dark:text-yellow-400 mb-3">3. 고용보험 - 실직의 불안을 덜고, 새로운 시작을 응원</h3>
          <p className="mb-3">실직한 근로자에게 실업급여를 지급하여 생계를 지원하고, 재취업 활동을 돕습니다. 또한 육아휴직 급여, 출산전후휴가 급여의 재원이 되기도 합니다.</p>
          <p className="font-mono p-4 bg-white dark:bg-gray-900 rounded-md text-sm">보험료 = 보수월액 × (실업급여 요율 + 고용안정·직업능력개발사업 요율)</p>
        ...
        <div className="p-5 rounded-lg bg-gray-100 dark:bg-gray-800 border-l-4 border-red-500">
    ...
    usefulTips: (
      <div className="text-base leading-relaxed space-y-8">
        <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-200 mt-10 mb-4">💡 4대 보험, 200% 활용하는 스마트 직장인 되기 (2025년 Ver.)</h2>
        <div className="space-y-6">
          <div className="p-5 rounded-lg bg-gray-50 dark:bg-gray-800 border-l-4 border-blue-500">
            <h4 className="font-bold text-lg text-blue-600 dark:text-blue-400">1. '비과세 소득' 항목부터 꼼꼼히 챙기세요.</h4>
          ...
          <div className="p-5 rounded-lg bg-gray-50 dark:bg-gray-800 border-l-4 border-green-500">
            <h4 className="font-bold text-lg text-green-600 dark:text-green-400">2. 건강보험, 내기만 하지 말고 '혜택'을 누리세요.</h4>
          ...
          <div className="p-5 rounded-lg bg-gray-50 dark:bg-gray-800 border-l-4 border-yellow-500">
            <h4 className="font-bold text-lg text-yellow-600 dark:text-yellow-400">3. 국민연금, '추납'과 '임의가입'으로 노후를 업그레이드하세요.</h4>
          ...
          <div className="p-5 rounded-lg bg-gray-50 dark:bg-gray-800 border-l-4 border-purple-500">
            <h4 className="font-bold text-lg text-purple-600 dark:text-purple-400">4. 고용보험, 실업급여 외 '내일배움카드'를 주목하세요.</h4>
          ...
          <div className="p-5 rounded-lg bg-gray-50 dark:bg-gray-800 border-l-4 border-red-500">
            <h4 className="font-bold text-lg text-red-600 dark:text-red-400">5. 이직/퇴사 시, '건강보험 임의계속가입' 제도를 활용하세요.</h4>
