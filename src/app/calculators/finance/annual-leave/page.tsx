          ...
          <>
            ...
            <ul className="space-y-6">
              <li className="p-4 rounded-md bg-muted shadow">
                <h4 className="font-semibold text-lg mb-2 text-primary">1. '연차 사용 촉진 제도', 함정이 될 수 있어요!</h4>
                <p>
              ...
              <li className="p-4 rounded-md bg-muted shadow">
                <h4 className="font-semibold text-lg mb-2 text-primary">2. 연차수당 청구권, 3년 안에 행사해야 해요.</h4>
                <p>
              ...
              <li className="p-4 rounded-md bg-muted shadow">
                <h4 className="font-semibold text-lg mb-2 text-primary">3. 퇴사 시 남은 연차, '수당'으로 두둑하게 챙기세요.</h4>
                <p>
              ...
              <li className="p-4 rounded-md bg-muted shadow">
                <h4 className="font-semibold text-lg mb-2 text-primary">4. 입사일 기준 vs 회계연도 기준, 내게 유리한 것은?</h4>
                <p>
              ...
              <li className="p-4 rounded-md bg-muted shadow">
                <h4 className="font-semibold text-lg mb-2 text-primary">5. 5인 미만 사업장, '약정 휴가'를 협의하세요.</h4>
                <p>
