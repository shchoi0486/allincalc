...
const CreditCardInstallmentFeeCalculator: NextPage = () => {
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          className="text-right"
        />
        <p className="text-sm text-muted-foreground mt-1">일반적으로 최대 36개월까지 가능합니다.</p>
      </div>
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          className="text-right"
        />
        <p className="text-sm text-muted-foreground mt-1">할부 개월 수보다 클 수 없습니다.</p>
      </div>
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          className="text-right"
        />
        <p className="text-sm text-muted-foreground mt-1">일반적으로 카드사마다 다르며 0.5%~1.5% 내외입니다.</p>
      </div>
  ...
  const infoSection = {
    ...
    calculationFormula: (
      <>
        <h3 className="text-xl font-bold text-foreground mt-8 mb-4">📈 할부 수수료, 어떻게 계산될까요?</h3>
        <p className="text-foreground leading-relaxed">
        ...
        <div className="mt-6 space-y-4">
          <div className="p-4 border-l-4 border-primary bg-muted rounded-r-lg">
            <h4 className="font-semibold text-lg mb-2 text-primary">월별 할부 수수료 계산</h4>
          ...
          <div className="p-4 border-l-4 border-primary bg-muted rounded-r-lg">
            <h4 className="font-semibold text-lg mb-2 text-primary">총 할부 수수료 (근사치)</h4>
            <p className="font-mono p-3 bg-muted rounded-md my-2 text-center text-sm">
    ...
    usefulTips: (
      <>
        <h3 className="text-xl font-bold text-foreground mt-8 mb-4">💡 할부 수수료 절약을 위한 5가지 꿀팁</h3>
        <ul className="space-y-6">
          <li className="p-4 rounded-lg bg-muted shadow-md transition-transform hover:scale-105">
            <h4 className="font-semibold text-lg mb-2 text-primary">1. 무이자 할부 혜택을 최대한 활용하세요.</h4>
            <p className="text-muted-foreground">가장 확실한 절약 방법입니다. 카드사나 가맹점에서 제공하는 무이자 할부 이벤트를 적극적으로 찾아보세요. 2~3개월 무이자 할부만 이용해도 상당한 수수료를 아낄 수 있습니다. 단, 무이자 할부 이용 시 카드 실적에서 제외되는 경우가 많으니 실적 조건도 함께 확인해야 합니다.</p>
          </li>
          <li className="p-4 rounded-lg bg-muted shadow-md transition-transform hover:scale-105">
            <h4 className="font-semibold text-lg mb-2 text-primary">2. 할부 개월 수는 짧을수록 좋습니다.</h4>
            <p className="text-muted-foreground">할부 개월 수가 길어질수록 매월 부담은 줄어들지만, 총 수수료는 눈덩이처럼 불어납니다. 12개월 할부의 총 수수료는 6개월 할부의 2배 이상이 될 수 있습니다. 감당할 수 있는 범위 내에서 최대한 짧은 개월 수를 선택하는 것이 현명합니다.</p>
          </li>
          <li className="p-4 rounded-lg bg-muted shadow-md transition-transform hover:scale-105">
            <h4 className="font-semibold text-lg mb-2 text-primary">3. '부분 무이자 할부'의 함정을 조심하세요.</h4>
            <p className="text-muted-foreground">"10개월 할부 시 1~3회차 무이자"와 같은 부분 무이자 할부는 언뜻 보면 유리해 보이지만, 나머지 4~10회차에는 정상 수수료가 부과됩니다. 전체 기간에 대한 총 수수료를 반드시 계산해보고 전체 무이자 할부와 비교해야 합니다.</p>
          </li>
          <li className="p-4 rounded-lg bg-muted shadow-md transition-transform hover:scale-105">
            <h4 className="font-semibold text-lg mb-2 text-primary">4. 선결제를 적극적으로 활용하세요.</h4>
            <p className="text-muted-foreground">여유 자금이 생겼다면 할부 잔액의 일부 또는 전부를 미리 갚는 '선결제'를 이용하세요. 선결제 시점 이후의 수수료는 면제되므로 총 수수료를 크게 줄일 수 있습니다. 대부분의 카드사 앱이나 홈페이지에서 간편하게 신청할 수 있습니다.</p>
          </li>
          <li className="p-4 rounded-lg bg-muted shadow-md transition-transform hover:scale-105">
            <h4 className="font-semibold text-lg mb-2 text-primary">5. 할부 결제 전, 정말 필요한 소비인지 다시 한번 생각하세요.</h4>
            <p className="text-muted-foreground">할부 수수료는 결국 '미래의 소득'을 앞당겨 쓰는 대가입니다. 할부 결제가 꼭 필요한 상황인지, 혹은 조금 기다렸다가 일시불로 구매할 수는 없는지 신중하게 고민하는 습관이 불필요한 지출을 막는 가장 근본적인 방법입니다.</p>
          </li>
        </ul>
      </>
    ),
