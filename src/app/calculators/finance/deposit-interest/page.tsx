...
const DepositInterestCalculator: NextPage = () => {
  ...
  const infoSection = {
    calculatorDescription: (
      <>
        <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-4">정기예금 이자 계산기: 잠자는 내 돈, 확실하게 깨우는 법</h2>
        ...
        <ul className="list-disc list-inside mt-4 space-y-2 text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
    ...
    calculationFormula: (
      <>
        <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200 mt-8 mb-4">💰 단리 vs 복리, 이자는 어떻게 계산될까?</h3>
        ...
        <div className="space-y-6">
          <div className="p-4 border-l-4 border-blue-500 bg-blue-50 dark:bg-gray-800 rounded-r-lg">
            <h4 className="font-semibold text-lg mb-2 text-blue-800 dark:text-blue-300">1. 단리 (Simple Interest)</h4>
            <p className="text-gray-600 dark:text-gray-400 mb-3">오직 <strong>처음 예치한 원금</strong>에 대해서만 약속된 이자를 계산하는 방식입니다. 이자가 발생하더라도 이를 원금에 포함시키지 않기 때문에, 매번 동일한 금액의 이자가 발생합니다. 계산이 단순하고 이해하기 쉽다는 특징이 있습니다.</p>
          ...
          <div className="p-4 border-l-4 border-green-500 bg-green-50 dark:bg-gray-800 rounded-r-lg">
            <h4 className="font-semibold text-lg mb-2 text-green-800 dark:text-green-300">2. 월복리 (Monthly Compound Interest)</h4>
            <p className="text-gray-600 dark:text-gray-400 mb-3">발생한 이자를 <strong>원금에 합산</strong>하고, 그 합산된 금액을 새로운 원금으로 간주하여 다음 기간의 이자를 계산하는 방식입니다. 이자가 이자를 낳는 구조로, 시간이 지날수록 이자가 기하급수적으로 늘어나는 ‘눈덩이 효과’를 기대할 수 있습니다.</p>
            <p className="font-mono p-3 bg-muted rounded-md my-2 text-center">
        ...
        <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200 mt-10 mb-4">💸 최종 수령액을 결정하는 ‘세금’ (2025년 기준)</h3>
        <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
          예금 이자는 ‘이자소득’으로 분류되어 세금이 부과됩니다. 따라서 최종 수령액은 세전 이자에서 세금을 제외한 금액이 됩니다. 과세 옵션에 따라 공제되는 세율이 다르므로, 자신에게 적용되는 세율을 정확히 아는 것이 중요합니다.
        </p>
        <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-md my-4 border border-gray-200 dark:border-gray-700">
          <p className="text-center font-semibold text-lg">
            세후 수령액 = 원금 + 세전 이자 - (세전 이자 × 세율)
          </p>
        </div>
        <ul className="list-disc pl-5 mt-6 space-y-4 text-gray-700 dark:text-gray-300">
    ...
    usefulTips: (
      <>
        <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200 mt-8 mb-4">💡 이자 한 푼이라도 더 받는 5가지 꿀팁</h3>
        <ul className="space-y-6">
          <li className="p-4 rounded-lg bg-white dark:bg-gray-800 shadow-md transition-transform hover:scale-105">
            <h4 className="font-semibold text-lg mb-2 text-blue-600 dark:text-blue-400">1. 발품 대신 ‘손품’을 팔아 금리를 비교하세요.</h4>
            <p className="text-gray-600 dark:text-gray-400">더 이상 높은 금리를 찾기 위해 여러 은행을 방문할 필요가 없습니다. 금융감독원의 ‘금융상품 한눈에’ 서비스나 은행연합회 소비자포털, 그리고 다양한 핀테크 앱(토스, 카카오뱅크, 뱅크샐러드 등)을 통해 모든 은행의 예금 금리를 실시간으로 비교하고 가장 좋은 조건을 쉽게 찾을 수 있습니다. 0.1%의 금리 차이라도 장기적으로는 큰 차이를 만듭니다.</p>
          </li>
          <li className="p-4 rounded-lg bg-white dark:bg-gray-800 shadow-md transition-transform hover:scale-105">
            <h4 className="font-semibold text-lg mb-2 text-green-600 dark:text-green-400">2. ‘특판 예금’ 출시 알림을 활용하세요.</h4>
            <p className="text-gray-600 dark:text-gray-400">은행들은 유동성 확보나 신규 고객 유치를 위해 종종 기본 금리보다 훨씬 높은 금리를 제공하는 ‘특판 예금’을 한시적으로 판매합니다. 판매 시작 몇 시간 만에 한도가 소진될 정도로 인기가 높습니다. 평소 관심 있는 은행의 앱 푸시 알림을 설정해두거나, 재테크 커뮤니티(예: 뽐뿌 재테크 포럼)를 주시하면 좋은 기회를 놓치지 않을 수 있습니다.</p>
          </li>
          <li className="p-4 rounded-lg bg-white dark:bg-gray-800 shadow-md transition-transform hover:scale-105">
            <h4 className="font-semibold text-lg mb-2 text-yellow-600 dark:text-yellow-400">3. ‘만기 자동 연장’은 다시 한번 생각해보세요.</h4>
            <p className="text-gray-600 dark:text-gray-400">만기 시 자동 연장 옵션은 편리하지만, 연장 시점의 금리가 현재보다 낮을 수 있습니다. 특히 금리 인상기에는 손해가 될 가능성이 높습니다. 만기가 도래하면 자동 연장하기보다는, 그 시점에서 가장 금리가 높은 다른 상품으로 갈아타는(재예치) 것이 대부분의 경우 더 유리합니다. 캘린더에 만기일을 꼭 표시해두세요.</p>
          </li>
          <li className="p-4 rounded-lg bg-white dark:bg-gray-800 shadow-md transition-transform hover:scale-105">
            <h4 className="font-semibold text-lg mb-2 text-red-600 dark:text-red-400">4. ‘비과세·세금우대’ 혜택을 최대한 활용하세요.</h4>
            <p className="text-gray-600 dark:text-gray-400">ISA(개인종합자산관리계좌)를 통해 예금을 운용하면 계좌 내에서 발생한 이자 및 배당소득에 대해 200만원(서민형은 400만원)까지 비과세 혜택을 받을 수 있습니다. 또한, 만 65세 이상이거나 장애인 복지법에 따른 장애인이라면 ‘비과세 종합저축’ 한도(5,000만원)를 반드시 활용하여 세금을 아끼는 것이 중요합니다.</p>
          </li>
          <li className="p-4 rounded-lg bg-white dark:bg-gray-800 shadow-md transition-transform hover:scale-105">
            <h4 className="font-semibold text-lg mb-2 text-purple-600 dark:text-purple-400">5. 예금자보호법 한도(5,000만 원)를 기억하세요.</h4>
            <p className="text-gray-600 dark:text-gray-400">만약의 사태에 대비해, 한 금융기관에는 원금과 이자를 합쳐 5,000만 원까지만 예치하는 것이 안전합니다. 예금자보호법은 금융회사가 파산하더라도 1인당 최대 5,000만 원까지 보호해주므로, 이 금액을 초과하는 목돈은 여러 은행에 나누어 예치하는 것이 현명한 방법입니다. 저축은행의 경우 금리가 높은 대신 안정성이 상대적으로 낮을 수 있으므로 이 원칙을 더욱 철저히 지키는 것이 좋습니다.</p>
          </li>
        </ul>
      </>
    ),
