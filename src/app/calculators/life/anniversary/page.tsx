  ...
  const infoSection = {
    calculatorDescription: `
      <div className="space-y-4">
        <p className="text-lg">기념일 계산기는 두 사람의 소중한 첫 만남, 결혼기념일, 아기의 백일이나 돌, 혹은 잊지 말아야 할 중요한 계약일까지, 삶의 모든 특별한 순간을 기억하고 기념할 수 있도록 도와주는 편리한 도구입니다.</p>
        ...
        <div className="p-4 bg-gray-100 dark:bg-gray-800 rounded-lg border-l-4 border-blue-500">
          <h3 className="font-semibold text-md mb-2">다양한 활용법:</h3>
    ...
    calculationFormula: `
      <div className="space-y-6">
        <div>
          <h3 className="font-semibold text-xl mb-2 border-b-2 border-gray-200 pb-2">기념일 계산의 핵심 원리</h3>
          <p className="mb-4">기념일 계산은 JavaScript의 <strong>Date 객체</strong>를 기반으로 이루어집니다. 사용자가 입력한 '기준일'과 '오늘 날짜'를 Date 객체로 변환한 후, 두 날짜 사이의 시간 차이를 밀리초(ms) 단위로 계산하는 것이 핵심입니다.</p>
          <div className="p-4 bg-gray-100 dark:bg-gray-800 rounded-lg">
            <code className="text-sm">const diffTime = Math.abs(today.getTime() - base.getTime());</code>
          </div>
          <p className="mt-4"><code>getTime()</code> 메소드는 1970년 1월 1일 00:00:00 UTC로부터 경과된 시간을 밀리초로 반환합니다. 이 값을 이용해 총 경과일을 계산할 수 있습니다.</p>
        </div>
        ...
        <div>
          ...
          <p className="mb-2">단순히 날짜를 나누는 것만으로는 정확한 개월 수를 계산하기 어렵습니다. 각 달의 일수가 다르기 때문입니다. 따라서 다음과 같은 단계로 계산합니다.</p>
        ...
        <div>
          ...
          <p className="mb-2">다음 기념일은 기준일의 연도를 현재 연도로 설정하는 것부터 시작합니다.</p>
          <div className="p-4 bg-gray-100 dark:bg-gray-800 rounded-lg">
          ...
          <p className="mt-2">만약 이렇게 설정된 날짜가 이미 지났다면(<code>nextAnniversary < today</code>), 연도를 1년 더해 다음 해의 기념일을 목표로 설정합니다.</p>
          ...
          <p className="mt-2">마지막으로, 오늘부터 다음 기념일까지 남은 날짜(D-day)는 두 날짜의 차이를 다시 일 단위로 계산하여 구합니다.</p>
        </div>
      </div>
    `,
    usefulTips: `
      <div className="space-y-6">
        <div className="p-4 rounded-lg border-l-4 border-green-500 bg-green-50 dark:bg-green-900/20">
          <h3 className="font-semibold text-lg mb-2">💡 기념일을 더 특별하게 만드는 팁</h3>
        ...
        <div className="p-4 rounded-lg border-l-4 border-yellow-500 bg-yellow-50 dark:bg-yellow-900/20">
          <h3 className="font-semibold text-lg mb-2">📅 D-Day 활용법</h3>
        ...
        <div className="p-4 rounded-lg border-l-4 border-red-500 bg-red-50 dark:bg-red-900/20">
          <h3 className="font-semibold text-lg mb-2">⚠️ 주의사항</h3>
