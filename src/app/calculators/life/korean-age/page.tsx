...
const KoreanAgeCalculator = () => {
  ...
  const infoSection = {
    calculatorDescription: `
      <div class="space-y-4">
        <p class="text-lg"><strong>"대체 제 나이가 몇 살이죠?"</strong> 한국의 복잡한 나이 계산법 때문에 한 번쯤은 가져봤을 의문입니다. 한국 나이 계산기는 이러한 혼란을 명쾌하게 해결해주는 도구입니다.</p>
    ...
    calculationFormula: `
      <div class="space-y-6">
        <h3 class="font-semibold text-xl mb-4 border-b-2 border-gray-200 pb-2">세 가지 나이, 어떻게 계산될까요?</h3>
        ...
        <div class="p-4 rounded-lg border-l-4 border-green-500 bg-green-50 dark:bg-green-900/20">
          ...
          <p class="mb-2">전 세계 공통으로 사용하는 국제 표준 나이 계산법이며, 2023년 6월부터 대한민국의 법적, 행정적 기준이 되었습니다.</p>
        ...
        <div class="p-4 rounded-lg border-l-4 border-blue-500 bg-blue-50 dark:bg-blue-900/20">
          <h4 class="font-semibold text-lg mb-2">2. 세는 나이 (Korean Age) - 전통적 관습</h4>
          <p class="mb-2">한국에서 전통적으로 사용해 온 나이 계산법으로, 주로 비공식적인 관계나 사회적 서열을 따질 때 사용됩니다.</p>
          <ul class="list-disc list-inside space-y-1">
        ...
        <div class="p-4 rounded-lg border-l-4 border-purple-500 bg-purple-50 dark:bg-purple-900/20">
          ...
          <p class="mb-2">주로 병역법, 청소년 보호법 등 일부 법률에서 규제의 편의성을 위해 사용하는 나이 계산법입니다.</p>
          <ul class="list-disc list-inside space-y-1">
    ...
    usefulTips: `
      <div class="space-y-6">
        <div class="p-4 rounded-lg border-l-4 border-yellow-500 bg-yellow-50 dark:bg-yellow-900/20">
          <h3 class="font-semibold text-lg mb-2">만 나이 통일법, 무엇이 달라졌을까요?</h3>
          <p class="mb-2">2023년 6월 28일부터 시행된 '만 나이 통일법'은 법률, 계약, 공문서 등에서 나이를 계산할 때 '만 나이'만을 사용하도록 명시한 법입니다. 이로 인해 발생하는 주요 변경점은 다음과 같습니다.</p>
          <ul class="list-disc list-inside space-y-2">
            ...
            <li><strong>주의! 계속 '연 나이'를 사용하는 경우:</strong> <span class="font-semibold">초중등교육법(취학 연령), 병역법(징병검사 연령), 청소년보호법(청소년 정의)</span> 등 일부 법률에서는 여전히 '연 나이'를 기준으로 하므로 주의가 필요합니다.</li>
          </ul>
        </div>
        <div class="p-4 rounded-lg border-l-4 border-red-500 bg-red-50 dark:bg-red-900/20">
          <h3 class="font-semibold text-lg mb-2">그래서, 술과 담배는 언제부터?</h3>
